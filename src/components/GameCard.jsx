function GameCard({ game }) {
  return (
    <div 
      className="group relative bg-gray-800 rounded-xl overflow-hidden border border-gray-700 hover:border-purple-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 flex-shrink-0 w-full h-full md:w-[180px] md:h-[270px] lg:w-[222px] lg:h-[334px]"
      role="article"
      aria-label={`Game: ${game.name}`}
      style={{
        // On mobile: maintain 2:3 aspect ratio, fill container
